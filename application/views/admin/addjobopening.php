                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form action="<?php echo base_url(); ?>admin/add_jobopening" method="post">
                                            <div class="form-group">
                                                ...
                                                <input id="position" name="position" type="text" class="form-control"
                                                    ...
                                                    placeholder="Enter the job position" required />
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div>
                                                <button id="add" type="submit" name="upload"
                                                    ...
                                                    <span id="payment-button-amount">Add Job Opening</span>
                                                </button>
                                            </div>
                                        </form>
                                    </div>
